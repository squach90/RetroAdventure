...
func _on_body_entered(body):
	...
	get_node("../Player/Camera2D/Inventory").perso_msg.text = "HOMME" # Replace with function body.
	get_node("../Player/Camera2D/Inventory").text_msg.text = "Feu bon\nViande bonne" # Replace with function body.
