...
func _on_body_entered(body):
	...
	get_node("../Player/Camera2D/Inventory").perso_msg.text = "MAGE" # Replace with function body.
	get_node("../Player/Camera2D/Inventory").text_msg.text = "Dans le cimetière des secrets\nle levier caché est la clé qui \néveillera les forces oubliées." # Replace with function body.
